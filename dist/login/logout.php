...
mysql_query("DELETE FROM userblobs WHERE code='".$_COOKIE[$sitename]."' AND action='session' LIMIT 1"); #Delete the current session blob
...
setcookie($sitename, $hash, strtotime('-30 days'), "/", $domain_simple); #Destroy the cookie by outdating it
